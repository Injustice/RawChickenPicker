...
public class Pick extends Node {
    ...
    public void execute() {
        ...
        if (chicken != null) {                                             // if chicken exists
            ...
            while (chicken == null) {                                           // while the chicken doesn't exist
                Var.status = "No chicken";                                          // change status
                sleep(500);                                                         // sleep for 500
                if (GroundItems.getNearest(Var.RAW_CHICKEN_ID) != null) {           // if the chicken exists
                    break outer;                                                        // break to label outer
                }                                                                   // end if
            }                                                                   //
        }                                                                   //
    }
